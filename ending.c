...
--*/
{
   ...
   if (wFade)
   {
      ...
      p = SDL_CreateRGBSurface(gpScreen->flags & ~SDL_SWSURFACE, 320, 200, 8,
...
--*/
{
   ...
   pUpper = SDL_CreateRGBSurface(gpScreen->flags & ~SDL_SWSURFACE, 320, 200, 8,
      gpScreen->format->Rmask, gpScreen->format->Gmask,
      gpScreen->format->Bmask, gpScreen->format->Amask);

   pLower = SDL_CreateRGBSurface(gpScreen->flags & ~SDL_SWSURFACE, 320, 200, 8,
      gpScreen->format->Rmask, gpScreen->format->Gmask,
      gpScreen->format->Bmask, gpScreen->format->Amask);
